...
export default function Home() {
  ...
  return (
    <main className={`flex flex-col min-h-screen items-center justify-between bg-no-repeat ${theme ? 'bg-[whitesmoke] text-black' : 'bg-[#171926]'}`}>
      <div className={`relative bg-no-repeat bg-cover h-[220px] sm:h-[220px] w-[100%] ${theme ? 'bg-[url("/bg-desktop-light.jpg")] bg-no-repeat bg-cover' : 'bg-[url("/bg-desktop-dark.jpg")] bg-no-repeat bg-cover'}`}>
